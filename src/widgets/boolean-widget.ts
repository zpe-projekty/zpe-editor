...
import { SchemaElementBoolean } from "~/editor";

export class BooleanWidget extends DOMNode<"div"> {
    private _schema: SchemaElementBoolean;
    private _data: Record<string, any>;
    private _checkbox: DOMNode<"input">;

    constructor(key: string, schema: SchemaElementBoolean, data: Record<string, any>) {
        super("div");
